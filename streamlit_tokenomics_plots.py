...
if node_type_option == r"Block Keeper":
   ...
   index=0,
    ...
    if plot_scale >= 16:
        ...
        xticks = list([i * SecondsInYear for i in xlabels])
        ax.set_xlabel(r'Time (in years)')
    ax.hlines(y=dec(0.294525) * minted_tokens_number_calc(12 * SecondsInMonth, TotalSupply, KFS, u_tokens, FRC, ParticipantsNum, number_of_purchased_licenses), xmin=0, xmax=TTMT, color='black', linewidth=0.5)
